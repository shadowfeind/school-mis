  ...
  const EcaDataBulkEdit =({bulkData,academicSubject, setOpenPopup})=>{
      ...
      return(
          <>
             ...
             {selectSubject && selectSubject.map((subject,index)=>(<StyledTableCell>{subject.ECAName}</StyledTableCell>))}
              </TableRow>
              </TableHead>
              <TableBody>
              {bulk &&
              bulk.map((subject, index) => (
                <StyledTableRow>
                  ...
                  {selectSubject && selectSubject.map((subject,index)=>(<StyledTableCell align="right">
                    <TextField
