...
import { GET_ALL_TEACHER_NOTIFICATION_FAIL, GET_ALL_TEACHER_NOTIFICATION_REQUEST, GET_ALL_TEACHER_NOTIFICATION_SUCCESS, GET_LIST_TEACHER_NOTIFICATION_FAIL, GET_LIST_TEACHER_NOTIFICATION_REQUEST, GET_LIST_TEACHER_NOTIFICATION_SUCCESS, GET_SINGLE_TO_CREATE_TEACHER_NOTIFICATION_FAIL, GET_SINGLE_TO_CREATE_TEACHER_NOTIFICATION_REQUEST, GET_SINGLE_TO_CREATE_TEACHER_NOTIFICATION_SUCCESS, POST_TEACHER_NOTIFICATION_FAIL, POST_TEACHER_NOTIFICATION_REQUEST, POST_TEACHER_NOTIFICATION_SUCCESS } from "./TeacherNotificationConstants";
...
export const getAllTeacherNotificationAction = () => async (dispatch) => {
  ...
  export const getSingleCreateTeacherNotificationAction = () => async (dispatch) => {
    try {
  ...
  export const postTeacherNotificationAction = (teacherNotification) => async (dispatch) => {
    try {
