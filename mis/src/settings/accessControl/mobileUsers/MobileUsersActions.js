...
import { GET_ALL_MOBILE_USER_FAIL, GET_ALL_MOBILE_USER_REQUEST, GET_ALL_MOBILE_USER_SUCCESS, GET_LIST_MOBILE_USER_FAIL, GET_LIST_MOBILE_USER_REQUEST, GET_LIST_MOBILE_USER_SUCCESS, GET_SINGLE_EDIT_MOBILE_USER_FAIL, GET_SINGLE_EDIT_MOBILE_USER_REQUEST, GET_SINGLE_EDIT_MOBILE_USER_SUCCESS, PUT_MOBILE_USER_FAIL, PUT_MOBILE_USER_REQUEST, PUT_MOBILE_USER_SUCCESS } from "./MobileUsersConstants";
...
export const getAllMobileUserAction = () => async (dispatch) => {
  ...
  export const putMobileUserAction =
  (mobileUser) => async (dispatch) => {
    try {
