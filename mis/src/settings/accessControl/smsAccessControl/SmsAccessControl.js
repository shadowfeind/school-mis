...
import { GET_ALL_SMS_ACCESS_CONTROL_RESET, GET_LIST_SMS_ACCESS_CONTROL_RESET, GET_SINGLE_TO_CREATE_SMS_ACCESS_CONTROL_RESET, GET_SINGLE_TO_EDIT_SMS_ACCESS_CONTROL_RESET, POST_SMS_ACCESS_CONTROL_RESET, PUT_SMS_ACCESS_CONTROL_RESET } from "./SmsAccessControlConstants";
import { getAllSmsAccessControlAction, getListSmsAccessControlAction, getSingleCreateSmsAccessControlAction, getSingleEditSmsAccessControlAction } from "./SmsAccessControlActions";
...
const useStyles = makeStyles((theme) => ({
  ...
  const { allSmsAccessControl, error } = useSelector((state) => state.getAllSmsAccessControl);

  const { listSmsAccessControl, error: listSmsAccessControlError, loading } = useSelector((state) => state.getListSmsAccessControl);

  const { singleCreateSmsAccessControl,success: singleCreateSmsAccessControlSuccess, error: singleCreateSmsAccessControlError } =
    useSelector((state) => state.getSingleToCreateSmsAccessControl);

const { singleEditSmsAccessControl,success: singleEditSmsAccessControlSuccess, error: singleEditSmsAccessControlError,loadingEdit } =
        ...
        <>
          ...
          >
            ...
            <SmsAccessControlForm
              smsCreate={singleCreateSmsAccessControl && singleCreateSmsAccessControl}
