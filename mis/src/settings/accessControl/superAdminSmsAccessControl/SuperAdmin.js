...
import { GET_ALL_SUPER_ADMIN_SMS_ACCESS_CONTROL_RESET, GET_LIST_SUPER_ADMIN_SMS_ACCESS_CONTROL_RESET, GET_SINGLE_CREATE_SUPER_ADMIN_SMS_ACCESS_CONTROL_RESET, GET_SINGLE_EDIT_SUPER_ADMIN_SMS_ACCESS_CONTROL_RESET, POST_SUPER_ADMIN_SMS_ACCESS_CONTROL_RESET, PUT_SUPER_ADMIN_SMS_ACCESS_CONTROL_RESET } from "./SuperAdminConstant";
import { getAllSuperAdminSmsAccessControlAction, getListSuperAdminSmsAccessControlAction, getSingleCreateSuperAdminSmsAccessControlAction, getSingleEditSuperAdminSmsAccessControlAction } from "./SuperAdminActions";
...
const useStyles = makeStyles((theme) => ({
  ...
  const { allSuperAdminSmsAccessControl, error } = useSelector((state) => state.getAllSuperAdminSmsAccessControl);

  const { listSuperAdminSmsAccessControl, error: listSuperAdminSmsAccessControlError, loading } = useSelector((state) => state.getListSuperAdminSmsAccessControl);

  const { singleCreateSuperAdminSmsAccessControl,success: singleCreateSuperAdminSmsAccessControlSuccess, error: singleCreateSuperAdminSmsAccessControlError } =
    useSelector((state) => state.getSingleToCreateSuperAdminSmsAccessControl);

const { singleEditSuperAdminSmsAccessControl,success: singleEditSuperAdminSmsAccessControlSuccess, error: singleEditSuperAdminSmsAccessControlError,loadingEdit } =
      ...
      return (
        <>
          ...
          >
              ...
              <>
            <SuperAdminForm
              smsCreate={singleCreateSuperAdminSmsAccessControl && singleCreateSuperAdminSmsAccessControl}
              smsEdit={singleEditSuperAdminSmsAccessControl && singleEditSuperAdminSmsAccessControl}
              setOpenPopup={setOpenPopup}
            />
            </>
            )}
