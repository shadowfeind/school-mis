...
import { GET_ALL_SMS_TEACHER_NOTIFICATION_FAIL, GET_ALL_SMS_TEACHER_NOTIFICATION_REQUEST, GET_ALL_SMS_TEACHER_NOTIFICATION_SUCCESS, GET_LIST_SMS_TEACHER_NOTIFICATION_FAIL, GET_LIST_SMS_TEACHER_NOTIFICATION_REQUEST, GET_LIST_SMS_TEACHER_NOTIFICATION_SUCCESS, GET_SINGLE_TO_CREATE_SMS_TEACHER_NOTIFICATION_FAIL, GET_SINGLE_TO_CREATE_SMS_TEACHER_NOTIFICATION_REQUEST, GET_SINGLE_TO_CREATE_SMS_TEACHER_NOTIFICATION_SUCCESS, POST_SMS_TEACHER_NOTIFICATION_FAIL, POST_SMS_TEACHER_NOTIFICATION_REQUEST, POST_SMS_TEACHER_NOTIFICATION_SUCCESS } from "./SmsTeacherNotificationConstants";
...
export const getAllSmsTeacherNotificationAction = () => async (dispatch) => {
  ...
  export const getListSmsTeacherNotificationAction = (date) => async (dispatch) => {
    try {
